 ...
 * @private
 */Dygraph.prototype.createMouseEventElement_ = function(){return this.maindiv_;}; /**
 ...
 *
 * Returns a two-element array: [X, Y].
 */Dygraph.prototype.eventToDomCoords = function(event){ // var rect = e.currentTarget.getBoundingClientRect(),
// offsetX = e.clientX - rect.left,
// offsetY = e.clientY - rect.top;
// if (offsetX && offsetY) {
// return [ offsetX, offsetY ];
// } else {
var eventElementPos=utils.findPos(this.mouseEventElement_);var canvasx=utils.pageX(event) - eventElementPos.x;var canvasy=utils.pageY(event) - eventElementPos.y;return [canvasx,canvasy]; // }
}; /**
 ...
 * takes care of cleanup of previously-drawn dots.
 * @private
 */Dygraph.prototype.updateSelection_ = function(opt_animFraction){ /*var defaultPrevented = */if(this.lastx_ !== -1){this.cascadeEvents_('select',{selectedRow:this.lastRow_ === -1?undefined:this.lastRow_,selectedX:this.lastx_,selectedPoints:this.selPoints_});} // TODO(danvk): use defaultPrevented here?
...
annotations.prototype.didDrawChart = function (e) {
  ...
  for (var i = 0; i < points.length; i++) {
    ...
    div.style.backgroundColor = g.colorsMap_[p.name];
